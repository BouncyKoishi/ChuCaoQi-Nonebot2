...
export const commands: Command[] = [
  ...
  },
  {
    name: 'rollds',
    params: '',
    description: '从deepseek图库中随机获取一张图片。',
    tags: [{ text: '群聊', type: 'warning' }],
    category: '群聊互动',
    subcategory: '图库'
  },
  ...
  },
  {
    name: '地震',
    params: '[地点] [震级下限]',
    description: '查询中国地震台网最新地震信息，支持按地点和震级筛选。',
    details: [
      '数据来源：中国地震台网（CENC），覆盖当年全量数据，实时更新',
      '无参数时返回最近5条地震记录',
      '输入数字（如5或3.5）筛选震级≥该值的地震',
      '输入地点名称进行地区筛选：省份走精确匹配，城市同时进行精确匹配和附近500km搜索',
      '可组合使用：!地震 成都 5 = 成都相关及附近500km内震级≥5.0的地震',
      '12小时内的地震记录会标记[新]',
      '示例：!地震、!地震 5、!地震 四川、!地震 成都、!地震 秘鲁 6'
    ],
    category: '实用功能',
    subcategory: '信息查询'
  },
...

  {
    name: 'model_change',
    params: '[模型名称]',
    description: '切换对话使用的语言模型。不提供参数时默认切换到 deepseek-v4-flash。',
    details: [
      '支持的预设模型：deepseek-v4-flash、deepseek-v4-pro、deepseek-vision（识图模型）、gpt-5-mini、gpt-5（需进阶模型权限）、lzusa（需进阶模型权限）、gemini-2.5-flash、gemini-2.5-pro（需管理员权限）',
