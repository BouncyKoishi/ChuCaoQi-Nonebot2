...
INSERT INTO "kusaitemlist" VALUES ('神灵祈愿', '拥有并启用后，允许你在生草时选择神灵草。发送"!生草 神灵草"会触发以下流程：反复种植并除草，直到种出神灵草或无法再消耗承载力为止。每次尝试种植会消耗承载力、灵性、金坷垃等资源和道具，未种出神灵草的轮次无任何收获，请注意资源消耗！', '能力', 1, 0, 2000, NULL, NULL, '草之精华', 1, '神灵草基因模块,除草机');

-- ----------------------------
-- Records of flag (global flags only)
-- ----------------------------
INSERT INTO "flag" ("name", "value", "forAll") VALUES ('生草预估详情展示', 1, 1);
INSERT INTO "flag" ("name", "value", "forAll") VALUES ('发送承载力回满信息', 0, 1);
INSERT INTO "flag" ("name", "value", "forAll") VALUES ('除草后自动生草', 0, 1);
