...
export const ALL_CARDS: CardData[] = [
  ...
  // 红魔乡 - 琪露诺
  { id: 29, cost: 1, name: '雹符「Hailstorm」', cardHp: 5, atkPoint: '1d7', defPoint: '1d1', dodPoint: '1d2', description: '宣言时：造成1点伤害', character: 'cirno', onCardSet(u, e) { const info = e.effectHurt(1); return `[${u.name}]冰雹暴风！造成1点伤害\n${info}` } },
  ...
  // 红魔乡 - 帕秋莉
  { id: 35, cost: 3, name: '火符「Agni Radiance」', cardHp: 6, atkPoint: '1d8', defPoint: '1d1', dodPoint: '1d2', description: '宣言时：造成3点伤害', character: 'patchouli', onCardSet(u, e) { const info = e.effectHurt(3); return `[${u.name}]火神的光辉！造成3点伤害\n${info}` } },
  ...
  { id: 46, cost: 5, name: '日符「Royal Flare」', cardHp: 7, atkPoint: '2d8', defPoint: '1d1', dodPoint: '1d1', description: '宣言时：造成4点伤害；每回合开始时：获得[弱化1]', character: 'patchouli', onCardSet(u, e) { const info = e.effectHurt(4); return `[${u.name}]皇家烈焰！造成4点伤害\n${info}` }, onTurnStart(u, _e) { u.appendEffect('Weaken', 1); return `[${u.name}]烈焰反噬！获得弱化1\n` } },
  ...
  { id: 59, cost: 4, name: '禁忌「Laevatein」', cardHp: 6, atkPoint: '2d8', defPoint: '1d1-1', dodPoint: '1d1', description: '宣言时：对方获得[贯穿1]', character: 'flandre', onCardSet(_u, e) { e.appendEffect('CantDefence', 1, '贯穿'); return `[${_u.name}]莱瓦汀！对方获得贯穿1\n` } },
