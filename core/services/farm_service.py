...
class FarmService:
    ...
    async def get_status(userId: int) -> Dict[str, Any]:
        ...
        result = {
            ...
            'vipBonus': vip_bonus,
            'kelaAvailable': kela_storage is not None and kela_storage.allowUse and kela_storage.amount >= field_amount if kela_storage else False,
            'kelaAmount': kela_storage.amount if kela_storage else 0,
            'doubleMagic': double_magic > 0,
            'spiritualSign': spiritual_sign > 0,
            'spiritualSignEffective': spiritual_sign > 0,
            ...
            'biogasPoolAvailable': biogas_storage is not None and biogas_storage.allowUse if biogas_storage else False,
